...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="anekBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" chatBot.Bot %CMD_LINE_ARGS%
